...
const Contact = () => {
  ...
  return <div className="relative min-h-screen bg-background overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-1 space-y-4">
                ...
                <a href="tel:+233595521498" className="block group">
                  <Card className="p-4 sm:p-6 bg-gradient-to-br from-green-500/10 to-emerald-500/5 border border-green-500/20 hover:border-green-500/40 transition-all duration-300 animate-fade-in" style={{
                ...
                <a href="mailto:techfluence.ai@outlook.com" className="block group">
                  <Card className="p-4 sm:p-6 bg-gradient-to-br from-blue-500/10 to-cyan-500/5 border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 animate-fade-in" style={{
                  animationDelay: '200ms'
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground text-center">Response within 1 minute</p>
                  </Card>
                </a>

                {/* 3. Book Consultation */}
                <a href="/book-consultation" className="block group">
                  <Card className="p-4 sm:p-6 bg-gradient-to-br from-primary/10 to-purple-500/5 border border-primary/20 hover:border-primary/40 transition-all duration-300 animate-fade-in cursor-pointer" style={{
                ...
                {/* 4. Business Hours */}
                <Card className="p-4 sm:p-6 bg-muted/50 border border-border/50 animate-fade-in" style={{
              ...
              <div className="lg:col-span-2">
                <Card className="p-4 sm:p-6 lg:p-8 bg-muted/50 border border-border/50 animate-fade-in" style={{
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input placeholder="Your full name" className="bg-background/50" value={formData.name} onChange={e => setFormData({
                        ...formData,
                        name: e.target.value
                      })} required />
                      </div>
                      <div>
                        ...
                        <Input type="email" placeholder="your.email@company.com" className="bg-background/50" value={formData.email} onChange={e => setFormData({
                        ...formData,
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input placeholder="+233 XX XXX XXXX" className="bg-background/50" value={formData.phone} onChange={e => setFormData({
                        ...formData,
                      ...
                      <div>
                        ...
                        <Input placeholder="Your company name" className="bg-background/50" value={formData.company} onChange={e => setFormData({
                        ...formData,
                    ...
                    <div>
                      ...
                      <Textarea placeholder="Tell us about your project requirements, current challenges, or how we can help you..." className="min-h-[100px] sm:min-h-[120px] bg-background/50" value={formData.message} onChange={e => setFormData({
                      ...formData,
                    ...
                    <Button type="submit" size="lg" className="w-full gradient-primary text-white border-0 hover:opacity-90" disabled={isSubmitting}>
              ...
              <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {/* Rapid Response */}
                <Card className="p-4 sm:p-6 bg-muted/50 border border-border/50 text-center animate-fade-in hover:border-primary/30 transition-all duration-300 flex flex-col items-center justify-center" style={{
                ...
                {/* 24/7 Support */}
                <Card className="p-4 sm:p-6 bg-muted/50 border border-border/50 text-center animate-fade-in hover:border-primary/30 transition-all duration-300 flex flex-col items-center justify-center sm:col-span-2 lg:col-span-1" style={{
      ...
      top: 0,
      behavior: 'smooth'
    })} className="fixed bottom-4 right-4 p-3 bg-primary text-white rounded-full shadow-lg hover:bg-primary/90 transition-all duration-300" aria-label="Back to top">
